...
def _build_prompt(analysis_package: dict) -> str:
    ...
    return f"""
You are the AI Decision Agent inside a platform-neutral Growth Decision Engine
for ecommerce, quick commerce, food delivery and other transaction marketplaces.
